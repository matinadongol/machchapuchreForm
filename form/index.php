...
<div class="container">
    <form action="process\form.php" method="post" enctype="multipart/form-data">
        ...
        <div class="row sectionrow">
            ...
            <div class="col-lg-3">
                <p><b>Birth Certificate of Applicant (Front) / जन्मदर्ता प्रमाण (अगाडि) <span class="red">*</span>
                    </b></p>
                <input type="file" class="inputTextField" name="applicantBirthCertificatePhoto"
                    id="applicantBirthCertificatePhoto">
            </div>
            <div class="col-lg-3">

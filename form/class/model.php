...
abstract class Model{
    ...
    final protected function insertForm(){
        try{
            ...
            global $guardianDetailsID;
            global $otherDocumentsDataID;
            $this->sql = "INSERT INTO form (firstSection, beneficialOwner, correspondenceAddress, permanentAddress, certificateDetails, occupationDetails, nomineeDetails, guardianDetails, otherDocuments) values ($firstSectionID, $beneficialOwnerID, $correspondenceAddressID, $permanentAddressID, $certificateDetailsID, $occupationDetailsID, $nomineeDetailsID, $guardianDetailsID, $otherDocumentsDataID); ";
